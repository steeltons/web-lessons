package org.jenjetsu.com.restapi.aspect;
...
public class PersistentBagCorrectAspect {
    ...
    private final String MODEL_CLASS_PATH = "org.jenjetsu.com.restapi.model";
    
    public PersistentBagCorrectAspect() {
        InputStream steam = this.getClass().getClassLoader().getResourceAsStream(MODEL_CLASS_PATH.replace('.', '/'));
    ...
    @Pointcut("execution(public * org.jenjetsu.com.restapi.service.*.*(*))")
