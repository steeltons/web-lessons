...
import org.jenjetsu.com.restapi.service.JpaService;
import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.transaction.annotation.Propagation;
import org.springframework.transaction.annotation.Transactional;

public class SimpleJpaService<E, ID extends Serializable> implements JpaService<E, ID> {
    ...
    public E create(E raw) {
        try {
            ...
            throw new EntityCreateException(format("Impossible to save Entity %s. Error message: %s", 
    ...
    public E update(E newEntity) {
        try {
            ...
            throw new EntityModifyException(format("Impossible to update Entity %s. Error message: %s", 
                                                   clazz.getSimpleName(), e.getMessage()), e);
        }
    }
    ...
    public void delete(E removeEntity) {
        try {
            ...
            throw new EntityDeleteException(format("Impossible to delete Entity %s. Error message: %s", 
                                                   clazz.getSimpleName(), e.getMessage()), e);
        }
    }
    ...
    public void deleteById(ID id) {
        try {
            ...
            throw new EntityDeleteException(format("Impossible to delete Entity %s with id %s. Error message: %s", 
                                                   clazz.getSimpleName(), 
                                                   id.toString(),
                                                   e.getMessage()), e);
        }
